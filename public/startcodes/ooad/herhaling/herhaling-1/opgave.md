...
- Properties `Artiest`, `Jaar` en `Nummers` (standaard lege lijst)
- Constructor met drie parameters: titel,artiest en  jaar
- Berekende property `TotaalDuurInSeconden`: som van `DuurInSeconden` van alle nummers
- Berekende property `TotaalDuurAlsTekst`: de totale duur in formaat `20:31`
...
Nacht — Bazart (2017) | 3 nummer(s) | 10:33 | EP
  1. Goud (3:47)
  2. Chaos (4:12)
  3. Wolf (2:34)
