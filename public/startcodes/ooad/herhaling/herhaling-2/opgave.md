...
- Constructor met naam en lidtype als parameters
- Methode `BerekenKortingsPercentage(Lidtype type)`: geeft het kortingspercentage terug — Junior: 50%, Senior: 10%, Veteraan: 30%
...
Jana Peeters | Senior | actief
Mathis Dubois | Junior | inactief
Rosa Martínez | Veteraan | actief
Luca De Smet | Senior | inactief
Amira Khalil | Junior | actief
```
